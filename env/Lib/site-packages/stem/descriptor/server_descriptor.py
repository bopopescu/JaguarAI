...
_parse_main_key_ed25519_line = _parse_simple_line('main-key-ed25519', 'ed25519_main_key')
_parse_main_key_ed25519_for_hash_line = _parse_simple_line('main-key-ed25519', 'ed25519_certificate_hash')
...
class RelayDescriptor(ServerDescriptor):
  ...
  :var str ed25519_main_key: base64 encoded main key for our ed25519 certificate
  ...
  **\*** attribute is required when we're parsed with validation
  ...
  .. versionchanged:: 1.5.0
     Added the ed25519_certificate, ed25519_main_key, ed25519_signature,
  ...
  ATTRIBUTES = dict(ServerDescriptor.ATTRIBUTES, **{
    ...
    'ed25519_main_key': (None, _parse_main_key_ed25519_line),
  ...
  PARSER_FOR_LINE = dict(ServerDescriptor.PARSER_FOR_LINE, **{
    ...
    'main-key-ed25519': _parse_main_key_ed25519_line,
...
class BridgeDescriptor(ServerDescriptor):
  ...
  ATTRIBUTES = dict(ServerDescriptor.ATTRIBUTES, **{
    'ed25519_certificate_hash': (None, _parse_main_key_ed25519_for_hash_line),
    'router_digest_sha256': (None, _parse_router_digest_sha256_line),
    '_digest': (None, _parse_router_digest_line),
  })

  PARSER_FOR_LINE = dict(ServerDescriptor.PARSER_FOR_LINE, **{
    'main-key-ed25519': _parse_main_key_ed25519_for_hash_line,
